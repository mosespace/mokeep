      ...
      <div className='flex h-screen w-16 flex-col justify-between border-e bg-white fixed top-0 bottom-0 left-0'>
        <div>
          <div className='inline-flex h-16 w-16 items-center justify-center'>
            {session?.user?.image ? (
              <span className='grid h-10 w-10 place-content-center rounded-full bg-gray-100 text-xs text-gray-600'>
                {/* {initials} */}
                <Image
              ...
              <span className='grid h-10 w-10 place-content-center rounded-full bg-gray-100 text-xs font-bold text-gray-600'>
                {initials}
              </span>
            )}
          </div>
