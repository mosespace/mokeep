            ...
            return (
              ...
              >
                ...
                <div className='p-4 md:p-6'>
                  ...
                  <h3 className='text-xl font-semibold uppercase text-gray-800 dark:text-gray-300 dark:hover:text-white'>
                    {item.title}
                  </h3>
