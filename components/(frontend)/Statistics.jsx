  ...
  return (
    <>
      <div className='grid grid-cols-2 gap-4 md:grid-cols-4 justify-center mx-auto my-20'>
        <div className='shadow-2xl shadow-gray-[#12172A] dark:shadow-none border border-violet-50 dark:border-blue-800 bg-white dark:bg-blue-700 rounded-md relative'>
        ...
        <div className='shadow-2xl shadow-gray-[#12172A] dark:shadow-none border border-violet-50 dark:border-blue-800 bg-white dark:bg-blue-700 rounded-md relative'>
          <div className='flex justify-center -translate-y-[1px]'>
            <div className='w-3/4'>
              <div className='h-[1px] bg-gradient-to-r from-transparent via-pink-550 to-transparent  w-full'></div>
            </div>
          </div>
          <div className='flex flex-col justify-center items-center text-center p-8'>
            <p className='font-bold mb-2 text-pink-500 dark:text-pink-540 text-2xl md:text-3xl lg:text-4xl'>
              20+
            </p>
            <p className='mb-0 leading-5 text-sm lg:text-base'>
              Years of experience
