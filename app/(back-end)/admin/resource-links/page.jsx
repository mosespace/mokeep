...
export default async function page() {
    const resourceLinks= await getData("/resourcelinks")
    // console.log(resourceLinks)
  return (
    <div>
      <Head title={"Create a category before you create the links"} link={"/admin/resource-links/create"}/>
            ...
            return(
                ...
                <div class="flex gap-3 bg-white border border-gray-300 rounded-xl overflow-hidden items-center justify-start">
                    ...
                    <div class="flex flex-col gap-2 py-2">
                        ...
                        <p class="text-gray-500 text-xs shrink-0 w-[300px]">
                            {link.description}
                        ...
                        <span class="flex items-center justify-start text-gray-500">
                            ...
                            <Link className='line-clamp-1' href={link.link}>{link.link}</Link>
                        </span>
